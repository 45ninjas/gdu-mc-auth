<h1>Welcome</h1>
<p>So, you would like to join the Minecraft server.</p>

<p>To join the Minecraft server you must be following Phazor and read (and accept) the rules.</p>
